                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <div class="">
                                    ...
                                    <input type="hidden" name="latitude" id="latitude" value="{{old('latitude', $flat->latitude)}}">
                                    <input type="hidden" name="longitude" id="longitude" value="{{old('longitude', $flat->longitude)}}">
                                    {{-- list suggestion  --}}
                                                ...
                                                <div class="p-1">
                                                    ...
                                                    @if (old('services') != null)
                                                        <input @checked(in_array($service->id, old('services', []))) value="{{ $service->id }}"
                                                            ...
                                                            id="{{ $service->id }}">
                                                    @else
                                                        <input @checked($flat->services->contains($service->id)) value="{{ $service->id }}" class="btn-check"
