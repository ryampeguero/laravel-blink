    ...
    <div class="container p-5 ms_shadow mt-4 ms_border p-4 mb-5">
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-7 col-md-12 mt-5">
                <form class="px-4" id='form-create' action="{{ route('admin.flats.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="container-fluid p-0 m-0">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div id='bathrooms' class="ms_input">
                                    <input id='input_value' type="hidden" name="bathrooms" value="{{ old('bathrooms', '1') }}">
                                    <button id="minus" class="input_btn">-</button>
                                    <span id="ms_value"></span>
                                    <button id="plus" class="input_btn">+</button>
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input value="{{ old('address') }}" name="address" class="form-control" type="text" id="address" autocomplete="off">
